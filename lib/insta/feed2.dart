...
class _Feed extends State<Feed2> with AutomaticKeepAliveClientMixin<Feed2> {
  ...
  _getFeed() async {
    ...
    var url =
        'https://us-central1-exalted-skein-274700.cloudfunctions.net/getFeed?uid=' +
            userId;

    print("#####calling cloud functions: " + url);
